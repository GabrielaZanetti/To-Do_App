...
// import TaskStruncture from './components/TaskStruncture';
...
export default function App() {
  ...
  useEffect(()=> {
    const name = prompt("What's your name?"); //Ask user for their name (will ask only once as we are passing empty array on line 21)
